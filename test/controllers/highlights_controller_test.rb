...
class HighlightsControllerTest < ActionController::TestCase
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post :create, highlight: { category_id: @highlight.category_id, description: @highlight.description, name: @highlight.name, trip_id: @highlight.trip_id, user_id: @highlight.user_id }
    end
  ...
  test "should update highlight" do
    patch :update, id: @highlight, highlight: { category_id: @highlight.category_id, description: @highlight.description, name: @highlight.name, trip_id: @highlight.trip_id, user_id: @highlight.user_id }
    assert_redirected_to highlight_path(assigns(:highlight))
  end
